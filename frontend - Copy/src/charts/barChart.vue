...
export default {
  ...
  methods: {
    update() {
      let newSeason = [
        {
        date: { year: 2021, month: 8, day: 19 },
        CIN: { wins: 65.0, losses: 57.0, games_back: 9.5 },
        MIL: { wins: 74.0, losses: 47.0, games_back: 0 },
        CHC: { wins: 54.0, losses: 69.0, games_back: 21.0 },
        STL: { wins: 61.0, losses: 58.0, games_back: 12.0 },
        PIT: { wins: 42.0, losses: 79.0, games_back: 32.0 },
      },
        {
        date: { year: 2021, month: 8, day: 20 },
        CIN: { wins: 65.0, losses: 57.0, games_back: 8.5 },
        MIL: { wins: 74.0, losses: 47.0, games_back: 0 },
        CHC: { wins: 54.0, losses: 69.0, games_back: 20.0 },
        STL: { wins: 61.0, losses: 58.0, games_back: 11 },
        PIT: { wins: 42.0, losses: 79.0, games_back: 31.0 },
      },
        {
        date: { year: 2021, month: 8, day: 19 },
        CIN: { wins: 65.0, losses: 57.0, games_back: 9.5 },
        ...
        {
        date: { year: 2021, month: 8, day: 30 },
        CIN: { wins: 65.0, losses: 57.0, games_back: 10.5 },
        MIL: { wins: 74.0, losses: 47.0, games_back: 0 },
        CHC: { wins: 54.0, losses: 69.0, games_back: 22.0 },
        STL: { wins: 61.0, losses: 58.0, games_back: 13.0 },
        PIT: { wins: 42.0, losses: 79.0, games_back: 33.0 },
      }
      ]
      ;
...
for (let i = 0; i < newSeason.length; i++) {
        ...
        reds
          ...
          .attr(
            "height",
            newSeason[i].CIN.games_back * singleGameHeight
          );
        redsLogo
          .transition()
          .ease(d3.easeLinear)
        ...
        brewers
          ...
          .attr(
            "height",
            newSeason[i].MIL.games_back * singleGameHeight
          );
        brewersLogo
          .transition()
          .ease(d3.easeLinear)
        ...
        cardinals
          ...
          .attr(
            "height",
            newSeason[i].STL.games_back * singleGameHeight
          );
        cardinalsLogo
          .transition()
          .ease(d3.easeLinear)
        ...
        cubs
          ...
          .attr(
            "height",
            newSeason[i].CHC.games_back * singleGameHeight
          );
        cubsLogo
          .transition()
          .ease(d3.easeLinear)
        ...
        pirates
          ...
          .attr(
            "height",
            newSeason.PIT.games_back * singleGameHeight
          );
        piratesLogo
          .transition()
          .ease(d3.easeLinear)
          ...
          .attr("y", newSeason.PIT.games_back * singleGameHeight);
      }
    },
  },
  mounted() {
